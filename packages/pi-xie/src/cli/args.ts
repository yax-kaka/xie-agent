	...
	const extensionFlagsText =
		extensionFlags && extensionFlags.length > 0
			? `\n${chalk.bold("Extension CLI Flags:")}\n${extensionFlags
					...
					.join("\n")}\n`
			: "";
	console.log(`${chalk.bold(APP_NAME)} - AI writing assistant with read, bash, edit, write tools
...
${chalk.bold("Options:")}
  ...
  --system-prompt <text>         System prompt (default: novel-writing assistant prompt)
