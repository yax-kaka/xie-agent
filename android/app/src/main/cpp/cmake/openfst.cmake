...
function(download_openfst)
  ...
  FetchContent_Declare(openfst
    ...
    PATCH_COMMAND
      ${CMAKE_COMMAND}
      -DOPENFST_SOURCE_DIR=<SOURCE_DIR>
      -P
      ${CMAKE_CURRENT_LIST_DIR}/patch-openfst.cmake
  )
  ...
  set_target_properties(fst PROPERTIES OUTPUT_NAME "sherpa-ncnn-fst")
  set_target_properties(fstfar PROPERTIES OUTPUT_NAME "sherpa-ncnn-fstfar")
